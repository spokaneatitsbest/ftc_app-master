 ...
 */
public class HardwarePushbotArmless
{
   ...
   /* public DcMotor  armMotor    = null;
    ...
    public void init(HardwareMap ahwMap) {
        ...
        leftLaunchMotor = hwMap.dcMotor.get("left_launch");
        rightLaunchMotor = hwMap.dcMotor.get("right_launch");
             //   armMotor    = hwMap.dcMotor.get("left_arm");
        leftMotor.setDirection(DcMotor.Direction.FORWARD); // Set to REVERSE if using AndyMark motors
        rightMotor.setDirection(DcMotor.Direction.REVERSE);// Set to FORWARD if using AndyMark motors
        leftLaunchMotor.setDirection(DcMotor.Direction.REVERSE);
        rightLaunchMotor.setDirection(DcMotor.Direction.FORWARD);
